...
```bash
# 1. Установка
curl -fsSL https://raw.githubusercontent.com/serjseiche/antiscan/master/install.sh | sudo bash
...
```bash
wget -qO- https://raw.githubusercontent.com/serjseiche/antiscan/master/install.sh | sudo bash
```
...
1. Скачайте нужный бинарник из [последнего релиза](https://github.com/serjseiche/antiscan/releases/latest):
